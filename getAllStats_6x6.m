% ChTopo_Oneshot
function getAllStats_6x6(x_fovea, y_fovea,cib_3Dsm, cob_3Dsm, OutputFP_Nm, OpticDiscSide)
...
[RGB_Thickness, stats3_cib_thicknes] =  get_quad_Circle_stats_Thickness_6x6(ThicknessMap,x_fovea, y_fovea,Excel_ThicknessStats,OpticDiscSide);
...
%Gaussian
[RGB_Kcib_org_diff, stats3_Kcib_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Kcib_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Gaus_Curv_CIB_diff,OpticDiscSide);
...
[RGB_Kcob_org_diff, stats3_Kcob_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Kcob_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Gaus_Curv_COB_diff,OpticDiscSide);
...
[RGB_Hcib_org_diff, stats3_Hcib_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Hcib_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Mean_Curv_CIB_diff,OpticDiscSide);
...
[RGB_Hcob_org_diff, stats3_Hcob_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Hcob_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Mean_Curv_COB_diff,OpticDiscSide);
...
%PrinicpalMin
[RGB_Pmincib_org_diff, stats3_Pmincib_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmincib_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Pmin_Curv_CIB_diff,OpticDiscSide);
...
[RGB_Pmincob_org_diff, stats3_Pmincob_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmincob_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Pmin_Curv_COB_diff,OpticDiscSide);
...
%PrinicipalMax
[RGB_Pmaxcib_org_diff, stats3_Pmaxcib_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmaxcib_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Pmax_Curv_CIB_diff,OpticDiscSide);
...
[RGB_Pmaxcob_org_diff, stats3_Pmaxcob_org_diff] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmaxcob_org_diff,x_fovea, y_fovea,fileNameExcel_Org_Pmax_Curv_COB_diff,OpticDiscSide);
...
%Gaussian
[RGB_Kcib_org, stats3_Kcib_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Kcib_org,x_fovea, y_fovea,fileNameExcel_Org_Gaus_Curv_CIB,OpticDiscSide);
filename_RGB_cib = strcat(OutputFP_Nm,'CIB_Gauss_org_Curvaturemap_with_Grid.jpg');
imwrite(RGB_Kcib_org,filename_RGB_cib);



[RGB_Kcob_org, stats3_Kcob_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Kcob_org,x_fovea, y_fovea,fileNameExcel_Org_Gaus_Curv_COB,OpticDiscSide);
filename_RGB_cob = strcat(OutputFP_Nm,'COB_Gauss_org_Curvaturemap_with_Grid.jpg');
imwrite(RGB_Kcob_org,filename_RGB_cob);

%Mean

[RGB_Hcib_org, stats3_Hcib_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Hcib_org,x_fovea, y_fovea,fileNameExcel_Org_Mean_Curv_CIB,OpticDiscSide);
filename_RGB_cib = strcat(OutputFP_Nm,'CIB_Mean_org_Curvaturemap_with_Grid.jpg');
imwrite(RGB_Hcib_org,filename_RGB_cib);

[RGB_Hcob_org, stats3_Hcob_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Hcob_org,x_fovea, y_fovea,fileNameExcel_Org_Mean_Curv_COB,OpticDiscSide);
...
%PrinicpalMin
[RGB_Pmincib_org, stats3_Pmincib_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmincib_org,x_fovea, y_fovea,fileNameExcel_Org_Pmin_Curv_CIB,OpticDiscSide);
filename_RGB_cib = strcat(OutputFP_Nm,'CIB_Pmin_org_Curvaturemap_with_Grid.jpg');
imwrite(RGB_Pmincib_org,filename_RGB_cib);

[RGB_Pmincob_org, stats3_Pmincob_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmincob_org,x_fovea, y_fovea,fileNameExcel_Org_Pmin_Curv_COB,OpticDiscSide);
filename_RGB_cob = strcat(OutputFP_Nm,'COB_Pmin_org_Curvaturemap_with_Grid.jpg');
imwrite(RGB_Pmincob_org,filename_RGB_cob);

%PrinicipalMax
[RGB_Pmaxcib_org, stats3_Pmaxcib_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmaxcib_org,x_fovea, y_fovea,fileNameExcel_Org_Pmax_Curv_CIB,OpticDiscSide);
filename_RGB_cib = strcat(OutputFP_Nm,'CIB_Pmax_org_Curvaturemap_with_Grid.jpg');
imwrite(RGB_Pmaxcib_org,filename_RGB_cib);

[RGB_Pmaxcob_org, stats3_Pmaxcob_org] =  get_quad_Circle_stats_GaussianCurvature_6x6(Pmaxcob_org,x_fovea, y_fovea,fileNameExcel_Org_Pmax_Curv_COB,OpticDiscSide);
