function [RGB, stats2] =  get_quad_Circle_stats_GaussianCurvature_6x6(c_img_org,x_fov, y_fov,filname_ETDRS_stats,OpticDiscSide)
...
RGB = insertText(c_img3,position,text_str1,'FontSize',35,'Font','Arial','TextColor','yellow','BoxColor','black','AnchorPoint','CenterBottom');
...
xlswrite(filname_ETDRS_stats,{'Region','Mean (Avg)','Standard deviation (SD)','Mininum','Maximum'},1,'A1');
