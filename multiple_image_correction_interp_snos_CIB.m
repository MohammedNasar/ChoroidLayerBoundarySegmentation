function [cib_3Dsm, oPath] = multiple_image_correction_interp_snos_CIB(snos,mFd,imgs)
...
%     title(fn);
    ...
    imwrite(CIB_image,filname_boundary); 
    CIB0(:,sno) = cib;  
end
...
save(strcat(MatF_NewPath,'Data.mat'),'cib_3Dsm');
